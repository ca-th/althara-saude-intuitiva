...
# --- Configurações ---
# Quantos dias no futuro você quer gerar? 365 = 1 ano
DIAS_PARA_GERAR = 365
# Nome do arquivo SQL que será criado
NOME_ARQUIVO_SQL = "popular_datas.sql"

# Pega a data de hoje como ponto de partida
data_inicial = datetime.date.today()

# Cria uma lista para guardar as datas válidas (dias de semana)
lista_datas_validas = []
...
for i in range(DIAS_PARA_GERAR):
    ...
    # Adicionamos apenas se for de Segunda a Sexta (0 a 4).
    if data_atual.weekday() < 5:
        # Formata a data para o formato 'YYYY-MM-DD' do SQL
...
# Junta todas as datas com uma vírgula
